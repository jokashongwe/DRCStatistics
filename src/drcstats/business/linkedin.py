...
if __name__ == "__main__":
    query = f"SELECT distinct company_legal_name, company_country FROM companies WHERE company_country = 'Democratic Republic of the Congo' order by company_legal_name asc;"
